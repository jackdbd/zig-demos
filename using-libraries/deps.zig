...
pub const package_data = struct {
    pub const _roe9in0tetqe = Package{
        .directory = dirs._roe9in0tetqe,
    };
    ...
    pub const _al1d3deiv60z = Package{
        ...
        .pkg = Pkg{ .name = "zlm", .source = .{ .path = dirs._al1d3deiv60z ++ "/zlm.zig" }, .dependencies = null },
    };
